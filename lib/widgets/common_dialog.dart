...
import 'package:his_quiz/admin/speed_round/round_1/winner_list/round_1_winner_list_screen.dart';
import 'package:his_quiz/admin/speed_round/round_2/round_2_screen.dart';
import 'package:his_quiz/admin/speed_round/round_2/winner_list/round_2_winner_list_screen.dart';
import 'package:his_quiz/admin/speed_round/round_3/round_3_screen.dart';
...
// Pick N Answer Round
class PickNAnswerRound extends StatefulWidget {
  final bool isGroup;
  final int totalStudent;
  const PickNAnswerRound({
    super.key,
    required this.totalStudent,
  ...
  @override
  State<PickNAnswerRound> createState() => _PickNAnswerRoundState();
}

class _PickNAnswerRoundState extends State<PickNAnswerRound> {
  int totalStudents = 0;
