...
class InternationalCardWidget extends StatefulWidget {
  final int index;
  const InternationalCardWidget({
    super.key,
    required this.index,
  });

  @override
  State<InternationalCardWidget> createState() =>
      _InternationalCardWidgetState();
}

class _InternationalCardWidgetState
    extends State<InternationalCardWidget> {
  @override
